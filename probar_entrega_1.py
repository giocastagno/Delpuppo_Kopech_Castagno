...
def probar_codigo(interactivo=False, saltear_errores=False):
    ...
    try:
        ...
        problemas.append(u'No se pudo encontrar el código python. Probablemente el nombre del archivo .py no es correcto.')
        return
...
def probar_estadisticas():
    ...
    if not os.path.exists(nombre_archivo):
        problemas.append(u'No se pudo encontrar el archivo de estadísticas')
        return
